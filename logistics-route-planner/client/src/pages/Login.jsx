...
export default function Login() {
  ...
  const { login, error, loading, user, setError } = useAuth();
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-primary-900 font-sans">
      <div className="w-full max-w-md p-8 glass-panel rounded-2xl relative z-10">
        ...
        <p className="text-gray-400 text-center mb-8">Sign in to your Logistics account</p>
